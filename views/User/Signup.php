    ...
    <div class="flex justify-center items-center h-full">
        <div class="bg-[#eaeaea] p-8 rounded-lg shadow-lg w-[90%] md:w-[400px] relative">
            ...
            <div id="signupForm" class="flex flex-col items-center">
                <h2 class="text-4xl font-semibold mb-4 text-[#915655]">Sign Up</h2>
                <form action="SignUp.php" method="POST" class="w-full">
                    <label for="name" class="block text-gray-700 font-medium mb-1">Name</label>
                    <input id="name" type="text" name="name" class="w-full px-4 py-2 mb-4 border rounded-md bg-[#fbfbfb]" required>
                    ...
                    <input id="signupPassword" type="password" name="password" class="w-full px-4 py-2 mb-4 border rounded-md bg-[#fbfbfb]" required>

                    <label for="repeatPassword" class="block text-gray-700 font-medium mb-1">Repeat Password</label>
                ...
                <p class="text-center mt-4">
                    ...
                    <a href="Login.php"><button id="switchToLogin" class="text-[#915655] font-semibold">Log in</button></a>
                </p>
            </div>
        </div>
    </div>
